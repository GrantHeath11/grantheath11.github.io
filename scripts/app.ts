 ...
 *     app.ts
 *
 *     Main ts/js file for loading data and making sure everything runs properly
 *
 *********************/
...
export async function loadHeader(): Promise<void> {
    ...
    try {
        ...
        if (headerElement) {
            ...
            console.error("[ERROR] <header> element not found in DOM.");
        }
    } catch (error) {
 ...
 */
function updateLoginLogoutButton(): void {
