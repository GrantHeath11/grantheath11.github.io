...
document.addEventListener("DOMContentLoaded", () => {
    ...
    feedbackForm.addEventListener("submit", (event) => {
        ...
        const modalFeedback = document.getElementById("modalFeedback") as HTMLElement;
        const confirmationModalElement = document.getElementById("confirmationModal") as HTMLElement;
